    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDoSomethingCoolButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                // c (1) Retrieve the text from the EditText and store it in a variable
                String myText = (String) mNameEntry.getText().toString();
                /*
                ...
                startChildActivityIntent.putExtra(Intent.EXTRA_TEXT, myText);
                /*
