...
public class MainActivity extends AppCompatActivity {
    ...
    // c (1) Create a key String called LIFECYCLE_CALLBACKS_TEXT_KEY
    ...
    // c (2) Override onSaveInstanceState
    @Override
    protected void onSaveInstanceState(Bundle outState){
        ...
        String stateText = (String) mLifecycleDisplay.getText().toString();

        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY, stateText);
    ...
    // c (3) Call super.onSaveInstanceState
    // c (4) Call logAndAppend with the ON_SAVE_INSTANCE_STATE String
    // c (5) Put the text from the TextView in the outState bundle
