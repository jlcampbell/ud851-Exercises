...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // c (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    private void setupSharedPreferences() {
        ...
        loadSizeScaleFromPreferences(sharedPreferences);
    ...
    private void loadSizeScaleFromPreferences(SharedPreferences sharedPreferences) {
        float minSize = Float.parseFloat(sharedPreferences.getString(getString(R.string.pref_edit_text_key), getString(R.string.pref_edit_text_default)));
