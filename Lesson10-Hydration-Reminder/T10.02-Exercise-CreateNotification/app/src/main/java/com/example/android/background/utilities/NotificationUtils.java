...
import static android.support.v4.R.id.text;
...
public class NotificationUtils {
    ...
    // https://developer.android.com/training/notify-user/build-notification.html
        // c (8) Get the NotificationManager using context.getSystemService
        // c (9) Create a notification channel for Android O devices
        // c (10) In the remindUser method use NotificationCompat.Builder to create a notification
        // that:
        ...
        // c (11) If the build version is greater than JELLY_BEAN and lower than OREO,
        // set the notification's priority to PRIORITY_HIGH.
        // c (12) Trigger the notification by calling notify on the NotificationManager.
    ...
    // c (1) Create a helper method called contentIntent with a single parameter for a Context. It
    // should return a PendingIntent. This method will create the pending intent which will trigger when
    // the notification is pressed. This pending intent should open up the MainActivity.
        // c (2) Create an intent that opens up the MainActivity
        // c (3) Create a PendingIntent using getActivity that:
    ...
    // c (4) Create a helper method called largeIcon which takes in a Context as a parameter and
    // returns a Bitmap. This method is necessary to decode a bitmap needed for the notification.
        // c (5) Get a Resources object from the context.
        // c (6) Create and return a bitmap using BitmapFactory.decodeResource, passing in the
