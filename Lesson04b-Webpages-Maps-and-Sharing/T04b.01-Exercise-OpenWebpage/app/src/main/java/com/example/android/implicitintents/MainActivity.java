...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        String mySite = "https://udacity.com";
    ...
    public void openWebPage(String mUriString){
        Uri webpageUri = Uri.parse(mUriString);
        Intent myIntent = new Intent();
        myIntent.setAction(Intent.ACTION_VIEW);
        myIntent.setData(webpageUri);
        if (mUriString != null) startActivity(myIntent);
    }
