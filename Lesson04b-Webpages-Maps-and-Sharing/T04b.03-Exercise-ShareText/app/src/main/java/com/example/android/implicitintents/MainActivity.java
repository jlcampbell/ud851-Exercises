...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickShareTextButton(View v) {
        // c (5) Specify a String you'd like to share
        String textToShare = "sharing is caring <3";

        // c (6) Replace the Toast with shareText, passing in the String from step 5
    ...
    // c (1) Create a void method called shareText that accepts a String as a parameter
    // Do steps 2 - 4 within the shareText method
        String mimeType = "text/plain";
        // c (2) Create a String variable called mimeType and set it to "text/plain"
        String title = "chooserWindow";
        // c (3) Create a title for the chooser window that will pop up

        // c (4) Use ShareCompat.IntentBuilder to build the Intent and start the chooser
