...
public class GreenAdapter extends RecyclerView.Adapter<GreenAdapter.NumberViewHolder> {
    ...
    // c (3) Create a final private ListItemClickListener called mOnClickListener
    ...
    // c (1) Add an interface called ListItemClickListener
    public interface ListItemClickListener{
        void onListItemClick(int index);

    }

    // c (2) Within that interface, define a void method called onListItemClick that takes an int as a parameter

    // c (4) Add a ListItemClickListener as a parameter to the constructor and store it in mOnClickListener
    /**
    ...
    // c (5) Implement OnClickListener in the NumberViewHolder class
    /**
    ...
    class NumberViewHolder extends RecyclerView.ViewHolder
        ...
        // c (6) Override onClick, passing the clicked item's position (getAdapterPosition()) to mOnClickListener via its onListItemClick method
        @Override
