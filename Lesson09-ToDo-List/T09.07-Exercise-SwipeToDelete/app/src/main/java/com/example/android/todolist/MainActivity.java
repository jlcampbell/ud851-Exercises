    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new ItemTouchHelper(new ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT | ItemTouchHelper.RIGHT) {
            ...
            public void onSwiped(RecyclerView.ViewHolder viewHolder, int swipeDir) {
                ...
                String tag = (String) viewHolder.itemView.getTag().toString();
                Uri contentUri = TaskContract.TaskEntry.CONTENT_URI;
                contentUri = contentUri.buildUpon().appendPath(tag).build();
                // TODO (1) Construct the URI for the item to delete
                //[Hint] Use getTag (from the adapter code) to get the id of the swiped item

                int deletions = getContentResolver().delete(contentUri, null, null);
